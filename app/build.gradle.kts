...
dependencies {
    ...
    implementation("tv.ogplayer:ogplayer-core:1.3.1")
    implementation("tv.ogplayer:ogplayer-ui:1.3.1")
    implementation("tv.ogplayer:ogplayer-ads-ima:1.3.1")
    implementation("tv.ogplayer:ogplayer-cast:1.3.1")
    implementation("tv.ogplayer:ogplayer-ads-freewheel:1.3.1")
